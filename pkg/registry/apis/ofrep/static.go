...
// Static eval is on-prem and single-tenant. All flags are treated as public
// (legacy /bootdata parity), so no filtering. Real gating is deferred until
// static config has a public source.
