...
//
// For external GRPC plugins: sets X-Grafana-HAR-Capture on the request headers so the
// SDK's HTTP capture middleware can detect and act on it across the GRPC boundary.
